...
ai_assistance_note: "Outline and copy-edit assistance; all experiences, numbers, and code are the author's."
---
...
> copy-editing. Every incident detail, number, and code sample is mine.
...
dominated a poll cycle, everything behind it waited.

I benchmarked the fix on staging with a replay of the incident traffic:
bounding fan-out per key brought p99 from 2.3s to 180ms on identical
hardware, and end-to-end lag recovered within 40 minutes of deploying.
...
— and our notifications don't need cross-key ordering.
...
before the feature, not after the outage. Capacity assumptions you don't
turn into tests are just hopes.
